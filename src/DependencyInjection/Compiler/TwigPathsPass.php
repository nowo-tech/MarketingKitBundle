...
namespace Nowo\MarketingKitBundle\DependencyInjection\Compiler;
...
/**
 * Registers bundle Twig paths so application overrides win (REQ-TWIG-001/002).
 */
final class TwigPathsPass implements CompilerPassInterface
{
    private const TWIG_NAMESPACE = 'NowoMarketingKitBundle';
    ...
    public function process(ContainerBuilder $container): void
    {
        ...
        if ($container->hasParameter('kernel.project_dir')) {
            ...
            if (is_string($projectDirParam)) {
                ...
                $overridePath = $projectDir . '/templates/bundles/NowoMarketingKitBundle';
